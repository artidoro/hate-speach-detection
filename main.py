...
from text_classification import model
from text_classification import utils
import hate_speach_utils


if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='Arguments for the text classification model.')
    parser.add_argument('--train_path', default='/home/artidoro/data/civility_data/train.tsv')
    parser.add_argument('--valid_path', default='/home/artidoro/data/civility_data/dev.tsv')
    parser.add_argument('--test_path', default='/home/artidoro/data/civility_data/test.tsv')
    parser.add_argument('--mini_demographics_path', default='/home/artidoro/data/civility_data/mini_demographic_dev.tsv')
    parser.add_argument('--fasttext_path', default='/home/artidoro/data/crawl-300d-2M-subword.vec')
    ...
    parser.add_argument('--load_vectors_manually', action='store_true')
    ...
    parser.add_argument('--false_positive_loss', default=0, type=float)
    ...
    train_iter, val_iter, test_iter, TEXT, LABEL = hate_speach_utils.torchtext_iterators(args)
    args['TEXT'] = TEXT
    args['LABEL'] = LABEL
    ...
    if args['mode'] == 'train':
        ...
        evaluation_results['valid'] = utils.eval(module, val_iter, args, write_to_file=args['write_to_file'])
        logger.info('\n' + pprint.pformat(evaluation_results), args)

    elif args['mode'] == 'test':
        logger.info('Starting testing.')
        hate_speach_utils.predict_write_to_file(module, test_iter, args)
